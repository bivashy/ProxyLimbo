...
import static dev.simplix.protocolize.api.util.ProtocolVersions.MINECRAFT_1_12;
import static dev.simplix.protocolize.api.util.ProtocolVersions.MINECRAFT_1_12_1;
...
/**
 * Source
 * <a href="https://github.com/AoElite/AutoReconnect/blob/da55aa46f40fbf4ec4af0e86704bb114c4e8cb6f/src/main/java/me/aoelite/bungee/autoreconnect/net/packets/PositionLookPacket.java#L16">https://github.com/AoElite/AutoReconnect/blob/da55aa46f40fbf4ec4af0e86704bb114c4e8cb6f/src/main/java/me/aoelite/bungee/autoreconnect/net/packets/PositionLookPacket.java#L16</a>
 */
public class UpdatePlayerPositionPacket extends AbstractPacket {
    ...
    public String toString() {
        return "PositionLookPacket(x=" + getX() + ", y=" + getY() + ", z=" + getZ() + ", yaw=" + getYaw() + ", pitch=" + getPitch() + ", flags=" + getFlags() + ", teleportId=" + getTeleportId() +
                ", dismountVehicle=" + getDismountVehicle() + ")";
    }
    ...
    public UpdatePlayerPositionPacket(double x, double y, double z, float yaw, float pitch, byte flags, int teleportId, boolean dismountVehicle) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.yaw = yaw;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePlayerPositionPacket)) {
            return false;
        }
        UpdatePlayerPositionPacket other = (UpdatePlayerPositionPacket) (o);
    ...
    protected boolean canEqual(Object other) {
        return other instanceof UpdatePlayerPositionPacket;
    }

    public int hashCode() {
        return Objects.hash(
                x, y, z, yaw, pitch, flags, teleportId, dismountVehicle);
    }
}
